...
\item Este volumen de recorte es comúnmente llamado Frustrum.
\item Todas las coordenadas que se encuentran dentro de la caja del Frustrum son mostrados en pantalla.
\end{itemize}
\end{frame}
...
\begin{itemize}
\item La matriz de una proyección ortogonal define una especie de caja como frustrum, la cual define el espacio de recorte.
\item Los vértices que quedan fuera de la caja son recortados.
\item Para especificar la matriz de proyección ortográfica es necesario definir ancho, alto y largo del frustrum.
\end{itemize}
\end{frame}
...
\item Los primeros dos parámetros especifican las coordenadas izquierda y derecha del frustrum.
