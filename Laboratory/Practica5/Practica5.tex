...
El alumno aprenderá la importancia y el uso del Modelado Jerárquico en la
creación de modelos y escenarios.
\subsection{Objetivos específicos:}
\begin{itemize}
\item El alumno comprenderá la necesidad de tener un diagrama jerárquico de los
modelos a crear.
\item El alumno aprenderá la importancia de la jerarquía al crear las animaciones de los
objetos.
\end{itemize}
...
El Modelado Jerárquico toma una estructura de árbol, mediante la cual indican la
jerarquía de primitivas que forman a un modelo.
\\
La jerarquía indica el orden de creación de los elementos y la forma en que se
distribuye el movimiento en una animación.
...
\begin{enumerate}
\item Dibujar y explicar el diagrama jerárquico del escenario a construir.
